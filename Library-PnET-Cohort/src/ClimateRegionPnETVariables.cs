...
namespace Landis.Library.PnETCohorts
{
    ...
    public class ClimateRegionPnETVariables : IEcoregionPnETVariables
    {
        ...
        public float CO2 => (float)_monthlyClimateRecord.CO2;   // Zhou, can replace with ramping function, like in EcoregionPnETVariables 
        ...
        public float NH4 => -999;   // not used, needed change the climate library, Zhou
        public float NO3 => -999; // not used, needed change the climate library, Zhou
