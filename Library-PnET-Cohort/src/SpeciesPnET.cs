...
namespace Landis.Library.PnETCohorts
{
    ...
    public class SpeciesPnET : ISpeciesPnET
    {
        ...
        public SpeciesPnET()
        {
            ...
            // CN parameters ZHOU
            folNConRange = ((Landis.Library.Parameters.Species.AuxParm<float>)(Parameter<float>)Names.GetParameter("folNConRange")); ////case insensitive
            maxNStore = ((Landis.Library.Parameters.Species.AuxParm<float>)(Parameter<float>)Names.GetParameter("maxNStore"));
            kho = ((Landis.Library.Parameters.Species.AuxParm<float>)(Parameter<float>)Names.GetParameter("kho"));
            nImmobA = ((Landis.Library.Parameters.Species.AuxParm<float>)(Parameter<float>)Names.GetParameter("NImmobA"));
            nImmobB = ((Landis.Library.Parameters.Species.AuxParm<float>)(Parameter<float>)Names.GetParameter("nImmobB"));

            folNRetrans = ((Landis.Library.Parameters.Species.AuxParm<float>)(Parameter<float>)Names.GetParameter("FolNRetrans"));
            fLPctN = ((Landis.Library.Parameters.Species.AuxParm<float>)(Parameter<float>)Names.GetParameter("FLPctN"));
            wLPctN = ((Landis.Library.Parameters.Species.AuxParm<float>)(Parameter<float>)Names.GetParameter("WLPctN"));
            rLPctN = ((Landis.Library.Parameters.Species.AuxParm<float>)(Parameter<float>)Names.GetParameter("RLPctN"));
            gRespFrac = ((Landis.Library.Parameters.Species.AuxParm<float>)(Parameter<float>)Names.GetParameter("GRespFrac"));
        ...
        public float FolNConRange
        {
            get
            {
                return _folNConRange * 1.0f; // Zhou, ZZX_scenario
            }
        }
        ...
        public float FLPctN
        {
            get
            {
                return _fLPctN * 1.0f;  // Zhou, Foliar N scenarios ZZX_scenario
            }
        }
